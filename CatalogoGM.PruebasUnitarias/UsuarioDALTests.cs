...
namespace CatalogoGM.AccesoADatos.Tests
{
    ...
    {
        private static Usuario usuarioInicial = new Usuario { Id = 2, RolId = 1, Login = "JuanUser", Password = "12345" };

        [TestMethod()]
        public async Task CrearAsyncTest()
        {
            var usuario = new Usuario();
            usuario.RolId = usuarioInicial.RolId;
            usuario.Nombre = "juan";
        ...
        public async Task BuscarIncluirRolesAsyncTest()
        {
            ...
            Assert.IsTrue(ultimoUsuario.Rol != null && usuario.RolId == ultimoUsuario.Rol.Id);
        }
